...
if (isset($_POST['nom'], $_POST['date_debut'], $_POST['date_fin'], $_POST['photo'])) {
    $photo = $_POST['photo'];
    $nom = $_POST['nom'];
    ...
    $query = $con->prepare("INSERT INTO evenement (nom, date_debut,date_fin,photo) VALUES ( ?,?,?,?)");
    $query->bind_param("ssss",  $nom,$date_debut,$date_fin,$photo);
    if ($query->execute()) {
        $answer['error'] = false;
